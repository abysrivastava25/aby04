...
USE [DB_VS]
GO
/****** Object:  Table [dbo].[Employee]    Script Date: 21-03-2020 01:29:14 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Library]    Script Date: 21-03-2020 01:29:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Library1]    Script Date: 21-03-2020 01:29:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TTN]    Script Date: 21-03-2020 01:29:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TTN1]    Script Date: 21-03-2020 01:29:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Employee] ([Id], [Name], [Salary]) VALUES (1, N'Abhishek', 35000)
GO
...
INSERT [dbo].[TTN1] ([Name], [Password], [City]) VALUES (N'abhishek ', N'abhi123', N'Allahabad ')
GO
/****** Object:  StoredProcedure [dbo].[proc_db]    Script Date: 21-03-2020 01:29:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[proc_Delete]    Script Date: 21-03-2020 01:29:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[proc_Delete1]    Script Date: 21-03-2020 01:29:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[proc_Delete1] 
    @emp_name varchar(30)
AS  
DELETE
FROM   Employee
WHERE  Name = @emp_name
GO
/****** Object:  StoredProcedure [dbo].[proc_Insert]    Script Date: 21-03-2020 01:29:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
